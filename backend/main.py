...
embarcacoes = [
    Embarcacao(id=1, nome="Barco Solimões", tipo="Transporte", velocidade=9.5, bandeira="Brasil", latitude=-1.78, longitude=-55.87),
    Embarcacao(id=2, nome="Amazon Star", tipo="Turismo", velocidade=6.2, bandeira="Brasil", latitude=-1.76, longitude=-55.85),
]
